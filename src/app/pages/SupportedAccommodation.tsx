...
import { ArrowLeft, Home, Users, MapPin, CheckCircle, Phone, Mail } from 'lucide-react';
...
export function SupportedAccommodation() {
  ...
  const accommodationTypes = [
    {
      ...
      description: 'Specialized support for young people aged 16-18 transitioning to independent living',
      age: '16-18 years',
      image: 'https://images.unsplash.com/photo-1675409145919-277c0fc2aa7d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb21mb3J0YWJsZSUyMGJlZHJvb20lMjBhY2NvbW1vZGF0aW9ufGVufDF8fHx8MTc3MjA1OTE4MHww&ixlib=rb-4.1.0&q=80&w=1080'
    },
    {
      title: '18+ Accommodation',
      description: 'Continued support for young adults preparing for complete independence',
      age: '18+ years',
  ...
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "'Poppins', sans-serif" }}>
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <p className="text-lg text-purple-100 leading-relaxed">
                Supporting young people looked after by local authorities across the United Kingdom 
                with quality accommodation and dedicated care.
              </p>
            </motion.div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-4">
                Caccou Family Services provides high-quality supported accommodation for young people 
                who are looked after by local authorities. We operate across the United Kingdom, 
                offering safe, nurturing environments where young people can develop the skills they 
                need for independent living.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Our support-only model ensures that each young person receives personalized care and 
                guidance while maintaining their independence and dignity. We work closely with local 
                authorities to provide comprehensive support tailored to individual needs.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="mb-16"
            >
              <h3 className="text-2xl md:text-3xl mb-6" style={{ fontWeight: 600, color: '#6B2D8B' }}>
                What We Offer
              </h3>
              <div className="grid sm:grid-cols-2 gap-4">
                {features.map((feature, index) => (
                  ...
                  >
                    <CheckCircle className="h-6 w-6 text-[#6B2D8B] flex-shrink-0 mt-0.5" aria-hidden="true" />
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {accommodationTypes.map((type, index) => (
              ...
              >
                ...
                <div className="p-6">
                  <div className="inline-block px-3 py-1 bg-purple-100 text-[#6B2D8B] rounded-full text-sm mb-3" style={{ fontWeight: 600 }}>
                    {type.age}
                  </div>
                  <h3 className="text-2xl mb-3" style={{ fontWeight: 600, color: '#6B2D8B' }}>
                    {type.title}
                  </h3>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-gray-700">
                Our supported accommodation facilities are located throughout the United Kingdom, 
                working in partnership with local authorities to provide accessible support where it's needed most.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <h3 className="text-2xl mb-6" style={{ fontWeight: 600, color: '#6B2D8B' }}>
                Our Facilities
              </h3>
      ...
      {/* Contact CTA */}
      <section className="py-16 md:py-20" style={{ backgroundColor: '#6B2D8B' }}>
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="text-lg text-purple-100 mb-8">
              Contact us to learn more about our supported accommodation services or to discuss placement options
            </p>
