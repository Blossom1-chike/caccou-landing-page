...
const testimonials = [
  {
    text: "The care and attention my mother receives from Caccou Family Services has been exceptional. The caregivers are professional, kind, and truly care about her wellbeing. I couldn't ask for a better service.",
    name: 'Sarah T.',
    role: 'Family Member, Harlow',
  },
  {
  ...
  return (
    <section id="about" className="py-20 md:py-28 bg-white">
      <div className="container mx-auto px-4">
        ...
        >
          <span className="inline-block px-4 py-1.5 bg-[#F3E8F9] text-[#6B2D8B] rounded-full text-sm mb-4" style={{ fontWeight: 500 }}>
            Who We Are
          </span>
          <h2
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Your trusted care partner in Harlow, dedicated to enhancing lives through
            compassionate, professional domiciliary care services.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center mb-20">
          ...
          >
            ...
            >
              Committed to{' '}
              <span className="text-[#6B2D8B]">Excellence</span> in Care
            </h3>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                At Caccou Family Services, we understand that choosing a care provider
                for yourself or a loved one is one of the most important decisions
                you'll make. That's why we're committed to delivering the highest
                standard of domiciliary care with dignity, respect, and compassion at
                the heart of everything we do.
              </p>
              <p>
                Based in Harlow, Essex, we serve our local community and surrounding
                areas, building lasting relationships with our clients and their
                families. Our team of experienced, trained caregivers are carefully
                selected for their skills, empathy, and dedication to making a positive
                difference in people's lives.
              </p>
              <p>
                We believe that everyone deserves to live life to the fullest,
                regardless of age or ability. Our person-centred approach ensures that
                each care plan is uniquely tailored to individual needs, preferences,
                and goals — promoting independence while providing the support needed.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mt-8">
              {[
                ...
                <div key={stat.label} className="text-center bg-[#F9F0FD] rounded-xl py-4 px-2">
                  <div className="text-2xl text-[#6B2D8B]" style={{ fontWeight: 700 }}>
                    {stat.number}
                  </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-20">
          {values.map((value, index) => (
            ...
            >
              ...
              <h4 className="text-lg text-[#2D1B4E] mb-2" style={{ fontWeight: 600 }}>
                {value.title}
              </h4>
        ...
        <div ref={testimonialRef}>
          ...
          >
            ...
            <h3 className="text-2xl md:text-3xl text-[#2D1B4E]" style={{ fontWeight: 700 }}>
