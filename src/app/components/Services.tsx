      ...
      <div className="container mx-auto px-4" ref={ref}>
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            We offer a comprehensive range of domiciliary care services tailored to
            meet the unique needs of each individual, delivered with compassion and
            professionalism.
          </p>
        </motion.div>
              ...
              <ul className="space-y-5">
                {[
                  ...
                  <li key={item.title} className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-[#2D1B4E] mb-0.5" style={{ fontWeight: 600 }}>
                        {item.title}
                      </p>
