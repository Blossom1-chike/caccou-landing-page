  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute -top-20 -right-20 w-80 h-80 rounded-full bg-[#F5A623]/10"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="text-white">
            ...
            >
              <span className="inline-block px-4 py-1.5 bg-white/15 backdrop-blur-sm rounded-full text-sm mb-6 border border-white/20">
            ...
            >
              ...
              for Your{' '}
              <span className="text-[#F5A623]">Loved Ones</span>
            </motion.h2>
            ...
            >
              Caccou Family Services delivers exceptional domiciliary care in Harlow
              and across Essex. Our dedicated team ensures dignity, independence, and
              quality of life for every individual we support.
            </motion.p>
            ...
            >
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button
                  ...
                  size="lg"
                  className="bg-[#F5A623] hover:bg-[#E09000] text-[#2D1B4E] text-lg px-8 rounded-full"
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="border-2 border-white/70 text-white hover:bg-white hover:text-[#6B2D8B] text-lg px-8 rounded-full"
                >
                  Free Consultation
                </Button>
              </motion.div>
            ...
            >
              {[
                { icon: Heart, label: 'Person-Centred', sublabel: 'Care Approach' },
                { icon: Shield, label: 'CQC Registered', sublabel: '& Regulated' },
                { icon: Users, label: '24/7 Support', sublabel: 'Always Available' },
              ].map((item, i) => (
                <motion.div
                  key={item.label}
          ...
          >
            <div className="relative">
              ...
              >
                ...
                <div>
                  <div className="text-sm text-gray-800" style={{ fontWeight: 600 }}>Trusted Care</div>
                  <div className="text-xs text-gray-500">Since establishment</div>
                </div>
              </motion.div>
